...
export default function CreativeCard({ project, isFlipped, onFlip }) {
  const handleClick = () => {
    if (onFlip) {
      onFlip(project.id);
    }
      ...
      >
        <div className="w-full h-48 bg-white/20 rounded-2xl mb-6 overflow-hidden">
          <div className="w-full h-full flex items-center justify-center bg-white/10">
            <span className="text-white text-sm font-medium">Creative AI Studio</span>
          </div>
        </div>
